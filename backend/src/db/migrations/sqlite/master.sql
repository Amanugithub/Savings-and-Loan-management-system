...
CREATE TABLE loans (
    ...
    status TEXT NOT NULL DEFAULT 'awaiting_recommendation'
        CHECK (status IN (
            'awaiting_guarantor',
            'guarantor_declined',
    ...
    declined_at TEXT,
    rejected_by TEXT REFERENCES administrators(id),
    rejected_at TEXT,
...
CREATE TABLE loan_installments (
    ...
    insurance_paid NUMERIC NOT NULL DEFAULT 0 CHECK (insurance_paid >= 0),

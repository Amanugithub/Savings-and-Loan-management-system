  ...
  return (
    <main className="relative grid min-h-svh place-items-center overflow-hidden bg-background p-4 md:p-8">
      ...
      <Select value={language} onValueChange={setLanguage}>
        <SelectTrigger id="login-language" size="sm" className="absolute right-16 top-4 w-auto min-w-24 rounded-xl bg-background md:right-24 md:top-8" aria-label="Language">

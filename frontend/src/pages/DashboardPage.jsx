...
function DashboardPage() {
  ...
  const isLoading = [membersQuery, loansQuery, transactionsQuery, expensesQuery].some((query) => query.isLoading)
  const error = [membersQuery, loansQuery, transactionsQuery, expensesQuery].find((query) => query.error)?.error
  ...
  const totalSavings = transactions.filter((transaction) => transaction.type === "savings_deposit").reduce((sum, transaction) => sum + Number(transaction.amount), 0)

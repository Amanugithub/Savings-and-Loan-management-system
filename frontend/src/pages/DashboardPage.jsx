...
import { canRecordTransaction, IN_REVIEW_STATUSES } from "@/lib/loan-workflow"
...
function DashboardPage() {
  ...
  const pendingLoans = loans.filter((loan) => IN_REVIEW_STATUSES.includes(loan.status))

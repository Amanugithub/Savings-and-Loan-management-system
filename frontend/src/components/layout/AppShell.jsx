    ...
    <TooltipProvider>
      <SidebarProvider>
          ...
          <header className="flex h-16 shrink-0 items-center gap-3 border-b bg-background/85 px-4 backdrop-blur md:px-6">
            ...
            <div className="flex-1">
              ...
              <p className="hidden text-xs text-muted-foreground sm:block">
                Here is today&apos;s cooperative overview.
              </p>
            </div>
              ...
              <PopoverTrigger
                render={
                  <Button
                    variant="ghost"
                    size="sm"
                    className="rounded-full p-1 pr-2 outline-none focus-visible:ring-2 focus-visible:ring-ring"
                  />
                }
              >
                <Avatar size="sm">
        ...
        <AlertDialog
          ...
          title="Sign out?"
          description="You are about to sign out of your administrator account. You will need to sign in again to access the management portal."
          cancelLabel="Cancel"
